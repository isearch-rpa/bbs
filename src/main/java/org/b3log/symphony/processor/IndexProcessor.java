...
//        	isIn="true";
//        }
//        final List<JSONObject> recentArticles = articleQueryService.getIndexRecentArticles(isIn,avatarViewMode);
...
//        dataModel.put(Common.SELECTED, Common.INDEX);
        ...
        final JSONObject domain = domainQueryService.getByURI("经验分享");
        if (null == domain) {
    ...
    public void showRecent(final HTTPRequestContext context, final HttpServletRequest request, final HttpServletResponse response)
        ...
        final JSONObject result = articleQueryService.getRecentArticles1(domainId,avatarViewMode, sortMode, pageNum, pageSize);
...
//        final JSONObject result = articleQueryService.getRecentArticles(avatarViewMode, sortMode, pageNum, pageSize);
    ...
    public void showPerfectArticles(final HTTPRequestContext context,
        ...
        final JSONObject result = articleQueryService.getPerfectArticles(domainId,avatarViewMode, pageNum, pageSize);
