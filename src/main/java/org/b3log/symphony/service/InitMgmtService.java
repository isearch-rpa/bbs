...
public class InitMgmtService {
    ...
    public void initSym() {
        ...
        try {
            ...
            domain1.put(Domain.DOMAIN_TITLE, "建议");
            domain1.put(Domain.DOMAIN_URI, "建议");
            domain1.put(Domain.DOMAIN_DESCRIPTION, "建议");
            domain1.put(Domain.DOMAIN_STATUS, 0);
            domainMgmtService.addDomain(domain1);
            
            JSONObject domain2 = new JSONObject();
            domain2.put(Domain.DOMAIN_TITLE, "支持");
            domain2.put(Domain.DOMAIN_URI, "支持");
            domain2.put(Domain.DOMAIN_DESCRIPTION, "支持");
            domain2.put(Domain.DOMAIN_STATUS, 0);
            domainMgmtService.addDomain(domain2);
            
            JSONObject domain3 = new JSONObject();
            domain3.put(Domain.DOMAIN_TITLE, "内部");
            domain3.put(Domain.DOMAIN_URI, "内部");
            domain3.put(Domain.DOMAIN_DESCRIPTION, "内部");
            domain3.put(Domain.DOMAIN_STATUS, 0);
            domainMgmtService.addDomain(domain3);
            
            JSONObject domain4 = new JSONObject();
            domain4.put(Domain.DOMAIN_TITLE, "资料");
            domain4.put(Domain.DOMAIN_URI, "资料");
            domain4.put(Domain.DOMAIN_DESCRIPTION, "资料");
            domain4.put(Domain.DOMAIN_STATUS, 0);
            domainMgmtService.addDomain(domain4);
            
            JSONObject domain5 = new JSONObject();
            domain5.put(Domain.DOMAIN_TITLE, "学习");
            domain5.put(Domain.DOMAIN_URI, "学习");
            domain5.put(Domain.DOMAIN_DESCRIPTION, "学习");
            domain5.put(Domain.DOMAIN_STATUS, 0);
            domainMgmtService.addDomain(domain5);
