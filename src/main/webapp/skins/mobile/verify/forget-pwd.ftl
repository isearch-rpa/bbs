...
<html>
    <head>
        <@head title="${forgetPwdLabel} - Rpa">
        <meta name="description" content="${forgetPwdLabel} Rpa"/>
        </@head>
            ...
            <div class="wrapper verify">
                <div class="verify-wrap">
                    <div class="form" style="text-align:center;">
                        <img src="${staticServePath}/images/login2.png"  style="height:55px; width:55px;padding-top:10px;padding-bottom:10px" />
