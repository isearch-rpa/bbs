...
<html>
    <head>
        <#if type == "index">
        <@head title="${consoleIndexLabel} - Rpa"></@head>
        </#if>
        <#if type == "users">
        <@head title="${userAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "addUser">
        <@head title="${addUserLabel} - Rpa"></@head>
        </#if>
        <#if type == "articles">
        <@head title="${articleAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "comments">
        <@head title="${commentAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "breezemoons">
        <@head title="${breezemoonAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "addDomain">
        <@head title="${addDomainLabel} - Rpa"></@head>
        </#if>
        <#if type == "domains">
        <@head title="${domainAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "tags">
        <@head title="${tagAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "addTag">
        <@head title="${addTagLabel} - Rpa"></@head>
        </#if>
        <#if type == "reservedWords">
        <@head title="${reservedWordAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "addReservedWord">
        <@head title="${allReservedWordLabel} - Rpa"></@head>
        </#if>
        <#if type == "addArticle">
        <@head title="${addArticleLabel} - Rpa"></@head>
        </#if>
        <#if type == "invitecodes">
        <@head title="${invitecodeAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "ad">
        <@head title="${adAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "misc">
        <@head title="${miscAdminLabel} - Rpa"></@head>
        </#if>
        <#if type == "roles">
            <@head title="${rolesAdminLabel} - Rpa"></@head>
        </#if>
    </head>
    <body>
        <#include "../header.ftl">
