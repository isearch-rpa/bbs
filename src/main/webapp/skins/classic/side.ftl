...
<div class="module">
    ...
    <div class="module-panel">
        <ul class="module-list">
            <#list prefectArticles as randomArticle>
            <li<#if !randomArticle_has_next> class="last"</#if>>
                <#if "someone" != randomArticle.articleAuthorName>
                <a rel="nofollow" href="${servePath}/member/${randomArticle.articleAuthorName}"></#if>
                    <span aria-label="${randomArticle.articleAuthorName}"
...
<#if newTags?size!=0 && isLoggedIn &&(currentUser.userRole=="memberRole" || currentUser.userRole=="adminRole")>
<div class="module">
    <div class="module-header">
        <h2>
            ${newTagLabel}
