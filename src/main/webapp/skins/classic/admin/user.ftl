...
<div class="content">
    <div class="module">
        ...
        <div class="module-panel form fn-clear">
            ...
            <label>机器码</label>
            <input type="text" value="${user.code}" readonly="readonly" />
    ...
    <div class="module">
        ...
        <div class="module-panel form fn-clear">
            <form action="${servePath}/admin/user/${user.oId}" method="POST">
                ...
                <label for="userNickname">${nicknameLabel}（建议填写用户真实姓名）</label>
    ...
    <div class="module">
        ...
        <div class="module-panel form fn-clear">
            ...
            <form action="${servePath}/admin/user/${user.oId}/code" method="POST">
                <label for="code">机器码</label>
