...
<html>
    <head>
        <@head title="${tag.tagTitle} - ${tagLabel} - Rpa">
                ...
                <div class="content" id="tag-pjax-container">
                    <#if pjax><!---- pjax {#tag-pjax-container} start ----></#if><div class="module">
                        ...
                        <div class="article-info fn-flex">
                            ...
                            <div class="fn-flex-1">
                                <span class="ft-gray ft-smaller">
                                    <a pjax-title="${tag.tagTitle} - ${tagLabel} - Rpa" rel="tag" class="ft-gray" href="${servePath}/tag/${tag.tagURI}"><strong>${tag.tagTitle}</strong></a> &nbsp;•&nbsp;
                        ...
                        <ul class="tag-desc fn-clear tag-articles-tag-desc">
                            ...
                            <li>
                                <a pjax-title="${relatedTag.tagTitle} - ${tagLabel} - Rpa" rel="tag" href="${servePath}/tag/${relatedTag.tagURI}">
                    ...
                    <div class="module">
                        <div class="module-header fn-clear">
                            <span class="fn-right ft-fade">
                                <a pjax-Title="${tag.tagTitle} - ${tagLabel} - Rpa" class="<#if "" == current>ft-gray</#if>" href="${servePath}/tag/${tag.tagURI}">${defaultLabel}</a>
                                /
                                <a pjax-Title="${tag.tagTitle} - ${tagLabel} - Rpa" class="<#if "/hot" == current>ft-gray</#if>" href="${servePath}/tag/${tag.tagURI}/hot">${hotArticlesLabel}</a>
                                /
                                <a pjax-Title="${tag.tagTitle} - ${tagLabel} - Rpa" class="<#if "/good" == current>ft-gray</#if>" href="${servePath}/tag/${tag.tagURI}/good">${goodCmtsLabel}</a>
                                /
                                <a pjax-Title="${tag.tagTitle} - ${tagLabel} - Rpa" class="<#if "/perfect" == current>ft-gray</#if>" href="${servePath}/tag/${tag.tagURI}/perfect"><svg class="fn-text-top"><use xlink:href="#perfect"></use></svg>${perfectLabel}</a>
                                /
                                <a pjax-Title="${tag.tagTitle} - ${tagLabel} - Rpa" class="<#if "/reply" == current>ft-gray</#if>" href="${servePath}/tag/${tag.tagURI}/reply">${recentCommentLabel}</a>
                            </span>
                        </div>
                        <@list listData=articles/>
                        <@pagination url="${servePath}/tag/${tag.tagURI}${current}" pjaxTitle="${tag.tagTitle} - ${tagLabel} - Rpa"/>
                    </div>
