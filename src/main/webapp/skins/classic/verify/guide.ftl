...
<html>
    <head>
        <@head title="${newbieGuideLabel} - Rpa">
        <meta name="description" content="${newbieGuideLabel} Rpa"/>
        </@head>
            ...
            <div class="wrapper verify guide">
                <div class="intro content-reset">
                    <dl>
                        ...
                        <dt><span class="index">4</span>提出建议</dt>
                        <dd class="ft-gray ft-smaller">欢迎对本社区提出宝贵的意见</dd>
                    </dl>
                    <div class="fn-none">
                        ${introLabel}
                    </div>
