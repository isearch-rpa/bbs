...
<div class="module person-info" style="height:140px;padding-top:30px">
<div class="module-panel tooltipped tooltipped-s" >
    <ul class="status fn-flex">
        <li class="fn-pointer" onclick="window.location.href = '${servePath}/article/1536127884356'">
            <img src="${staticServePath}/images/problem.png"   />
            <span class="ft-gray">常见问题</span>
        </li>
        <li class="fn-pointer" onclick="window.location.href = '${servePath}/article/1535958889452'">
            <img src="${staticServePath}/images/study.png" />
            <span class="ft-gray">学习资料</span>
        </li>
        <li class="fn-pointer" onclick="window.location.href = '${servePath}/article/1536113541605'">
            <img src="${staticServePath}/images/paly.png"   />
            <span class="ft-gray">学习计划</span>
        </li>
    </ul>
</div>
</div>