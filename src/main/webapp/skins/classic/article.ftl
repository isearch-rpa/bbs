...
<html>
    <head>
        <@head title="${article.articleTitleEmojUnicode} - Rpa">
        ...
        <meta property="og:title" content="${article.articleTitle} - Rpa" />
        ...
        <meta name="twitter:title" content="${article.articleTitle} - Rpa" />
    ...
    <body itemscope itemtype="http://schema.org/Product" class="article">
            ...
            <div class="wrapper">
                <div class="article-info fn-flex">
                    ...
                    <div class="fn-flex-1 fn-ellipsis">
                        ...
                        <#if article.articleAuthor.userNickname != ''>
                        	<span style="color:#616161">(${article.articleAuthor.userNickname})</span>
                    	</#if>
                        <br/>
                        <#if "" != article.articleAuthorIntro>
                            <span class="ft-gray">${article.articleAuthorIntro}</span>
                        <#else>
                            <span class="ft-gray">Rpa <#if article.articleAnonymous == 0>${article.articleAuthor.userNo?c}<#else>?</#if> ${numVIPLabel}</span>
                        </#if>
                        <br/>
        ...
        <div class="main <#if article.articleComments?size == 0> fn-none</#if>">
            <div class="wrapper" id="articleCommentsPanel">
                ...
                <div class="module comments" id="comments">
                    ...
                    <@pagination url="${servePath}${article.articlePermalink}" query="m=${userCommentViewMode}#comments" pjaxTitle="${article.articleTitle} - Rpa" />
                </div>
        ...
        <#if isLoggedIn && discussionViewable>
