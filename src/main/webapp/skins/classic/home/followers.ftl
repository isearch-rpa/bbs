...
<div class="tabs-sub fn-clear">
    ...
    <a pjax-title="${followersLabel} - ${user.userName} - Rpa"  href="${servePath}/member/${user.userName}/followers"<#if type == "followers"> class="current"</#if>>${followersLabel} &nbsp;<span class="count">${paginationRecordCount}</span></a>
...
<@pagination url="${servePath}/member/${user.userName}/followers" pjaxTitle="${followersLabel} - ${user.userName} - Rpa"/>
<#else>
