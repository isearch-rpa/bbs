...
<div class="tabs-sub fn-clear">
    ...
    <a pjax-title="${followingUsersLabel} - ${user.userName} - Rpa" href="${servePath}/member/${user.userName}/following/users"<#if type == "followingUsers"> class="current"</#if>>${followingUsersLabel} &nbsp;<span class="count">${paginationRecordCount}</span></a>
...
<@pagination url="${servePath}/member/${user.userName}/following/users" pjaxTitle="${followingUsersLabel} - ${user.userName} - Rpa"/>
<#else>
