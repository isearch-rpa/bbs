        ...
        <div class="side">
            ...
            <div class="module fn-none">
                ...
                <div class="module-panel fn-oh">
                    <nav class="home-menu">
                        <a pjax-title="${articleLabel} - ${user.userName} - Rpa" <#if type == "home" || type == "comments" || type == "articlesAnonymous" || type == "commentsAnonymous">
                                    class="current"</#if>
                           href="${servePath}/member/${user.userName}">
                            <svg>
                                <use xlink:href="#addfile"></use>
                            </svg> ${postLabel}</a>
                        <a pjax-title="${watchingArticlesLabel} - ${user.userName} - Rpa" <#if type == "watchingArticles" || type == "followingUsers" || type == "followingTags" || type == "followingArticles" || type == "followers" || type == "breezemoons">
                           class="current"</#if>
                           href="${servePath}/member/${user.userName}/watching/articles">
                            <svg>
                                <use xlink:href="#star"></use>
                            </svg> ${followLabel}</a>
                        <a pjax-title="${pointLabel} - ${user.userName} - Rpa" <#if type == "points">
