...
<div class="tabs-sub fn-clear">
    <a pjax-title="${articleLabel} - ${user.userName} - Rpa" href="${servePath}/member/${user.userName}"<#if type == "home"> class="current"</#if>>${articleLabel}<#if type == "home"> &nbsp;<span class="count">${paginationRecordCount?c}</span></#if></a>
    <a pjax-title="${cmtLabel} - ${user.userName} - Rpa" href="${servePath}/member/${user.userName}/comments"<#if type == "comments"> class="current"</#if>>${cmtLabel}</a>
    ...
    <a pjax-title="${anonymousCommentLabel} - ${user.userName} - Rpa"<#if type == "commentsAnonymous"> class="current"</#if> href="${servePath}/member/${user.userName}/comments/anonymous">${anonymousCommentLabel}</a>
    </#if>
</div>
...
<@pagination url="${servePath}/member/${user.userName}" pjaxTitle="${articleLabel} - ${user.userName} - Rpa"/>
<#else>
